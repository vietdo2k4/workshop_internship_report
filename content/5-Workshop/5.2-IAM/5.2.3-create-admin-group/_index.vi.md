...
![Create Group](/images/5-Workshop/5.2-IAM/5.2.3-create-user-group/IAM2.1.png)

2. Đặt tên cho nhóm IAM (ví dụ: `ExamoraAdminGroup`):

![Set Group Name](/images/5-Workshop/5.2-IAM/5.2.3-create-user-group/IAM2.2.png)
...
![Attach AdministratorAccess](/images/5-Workshop/5.2-IAM/5.2.3-create-user-group/IAM2.3.png)
...
![Group Created Successfully](/images/5-Workshop/5.2-IAM/5.2.3-create-user-group/IAM2.4.png)
